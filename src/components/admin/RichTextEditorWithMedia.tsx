...
/**
 * Enhanced RichTextEditor with media library integration
 * Provides WYSIWYG editing with media picker for images
 */
export function RichTextEditorWithMedia({
  content,
  onChange,
  ...
  // Combined image handler with media library option
  const addImage = useCallback(() => {
    if (!editor) return;

    const choice = window.confirm(
      'Click OK to choose from Media Library, or Cancel to enter a URL'
    );
